...
const unieai = createOpenAI({
  baseURL: 'https://api.exp.unieai.com/v1',
  // apiKey: 'sk-XnbHbzBOmPYGHgL_jLpgcJNSnog78lNayG2CVU5O0MDQ4iVZ_u4XLhva1Dc'
  apiKey:'sk-HUVxtjSNhs0cYIE_PyAXMJ9F7djn2WWtJTc8-ViEXobhvl4RP_tRxywOBz0'
});
...
export const scira = customProvider({
  languageModels: {
    ...
    //   middleware,
    // }),
    'scira-default': wrapLanguageModel({
      model: unieai('Qwen3-30B-A3B'),
      middleware,
    }),
    'scira-qwen-30b': wrapLanguageModel({
      model: unieai('Qwen3-30B-A3B'),
    ...
    'scira-nano': wrapLanguageModel({
      model: unieai('Qwen2.5-1.5B-Instruct'),
      middleware,
    }),
    'scira-qwen-1.5b': wrapLanguageModel({
      model: unieai('Qwen2.5-1.5B-Instruct'),
      middleware,
    }),
...
export const models = [
  ...
  // },
  {
    ...
    label: 'Qwen 3 30B A3B by UnieAI',
    description: "UnieAI's most efficient reasoning model",
    vision: false,
    reasoning: true,
    experimental: false,
    category: 'Pro',
  ...
  {
    value: 'scira-nano',
    label: 'Qwen2.5-1.5B-Instruct by UnieAI',
    description: "UnieAI's powerful SLM",
    vision: false,
    reasoning: false,
    experimental: false,
    category: 'Mini',
